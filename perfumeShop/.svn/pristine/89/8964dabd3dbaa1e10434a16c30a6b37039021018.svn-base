                ...
                <form action="#" class="billing-form">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="text" placeholder="Name*" onfocus="this.placeholder=''" onblur="this.placeholder = 'First name*'" required class="common-input" >
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="order-wrapper mt-50">
                                ...
                                <div class="order-list">
                                    ...
                                    <p class="payment-info">Pay via PayPal; you can pay with your credit card if you donât have a PayPal account.</p>
