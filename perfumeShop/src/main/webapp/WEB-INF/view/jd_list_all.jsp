...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
        <%
	//String sCustomerId=(String)session.getAttribute("aa");
	//boolean isLogin=false;
	//if(sCustomerId!=null){
	//	isLogin=true;
	//}
	String sCustomerId="aa";
%>
<%
	...
	ArrayList<HashMap> jumundetailList=
		(ArrayList<HashMap>)request.getAttribute("jdList");
		...
		<td><br />
			...
			<form name="f" method="post" >
				...
				<table border="0" cellpadding="0" cellspacing="1" width="590"
					...
					<tr>
						<td width=50 align=center bgcolor="ffffff" height="20"><%=jd.get("j_no")%></td>
						<td width=300 bgcolor="ffffff" style="padding-left: 10">
							<a href="jd_list_id?jd_no=<%=jd.get("j_no")%>" class="user">
						 	<%=jd.get("j_no")%>
							</a>
						</td>
