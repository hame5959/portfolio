...
<%
	ArrayList<Tag> tagList=
		(ArrayList<Tag>)request.getAttribute("tagList");
		...
		<td><br />
			...
			<form name="f" method="post" >
				...
				<table border="0" cellpadding="0" cellspacing="1" width="590"
					...
					<%for (Tag tag : tagList){%>
					<tr>
						<td width=50 align=center bgcolor="ffffff" height="20"><%=tag.t_no%></td>
						<td width=300 bgcolor="ffffff" style="padding-left: 10">
							<a href="tag_view?t_no=<%=tag.t_no%>" class="user">
						 	<%=tag.t_name%>
							</a>
						</td>
			...
			<table border="0" cellpadding="0" cellspacing="1" width="590">
				<tr>
					<td align="right"><input type="button"
						onclick="tagCreateform();" value="태그 쓰기" /></td>
				</tr>
			</table></td>
	</tr>
</table>
