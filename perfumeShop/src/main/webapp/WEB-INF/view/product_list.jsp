								...
								<div class="col-xl-4 col-lg-6 col-md-12 col-sm-6 single-product">
								  <div class="content">
								      <div class="content-overlay"></div>
								  		<a href="product_view1?p_no=<%=product.p_no%>"> <img class="content-image img-fluid d-block mx-auto" src="./img/product/<%=product.p_image%>" alt=""></a>
								  ...
								  <div class="price">
								  		<h5><a href="product_view1?p_no=<%=product.p_no%>"><%=product.p_name %></a></h5>
