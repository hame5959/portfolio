           ...
           <!-- loop start -->
            ...
            <%for(HashMap cart:cartList){%>
               <input type="hidden" name = "m_id" value=<%=m_id %> >
                <div class="cart-single-item">
                    <div class="row align-items-center">
                        <div class="col-md-2 col-2">
                            ...
                            <input type="hidden" id = "p_no" name="p_no" value=<%=cart.get("p_no")%>>
                        <input type="hidden" id = "cart_no" name="cart_no" value=<%=cart.get("cart_no")%>>
                               <input type="checkbox" id="checkOne" name="checkOne" value=<%=cart.get("cart_no")%>>
                               <input
											type="hidden" name="cart_date"
											value="<%=cart.get("cart_date")%>">
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                            <div class="product-item d-flex align-items-center">
                                <img src="/jenkim49/src/main/webapp/WEB-INF/view/image/<%=cart.get("p_image") %>" class="img-fluid" alt="">
                                <h6><input type="hidden"  name="p_name" value="<%=cart.get("p_name")%>"/><%=cart.get("p_name")%></h6>
                            </div>
                        </div>
                        <div class="col-md-2 col-2">
                            <div class="volume"><%=cart.get("p_volume")%></div>
                        </div>
                        <div class="col-md-2 col-2">
                            <div class="price">
                            <div class="priceppp"><%=cart.get("cart_price")%></div> <input type="hidden" name="checkppp" class="pricepp"  id="cart_price"    value="<%=cart.get("cart_price") %>" />
                       <input type="hidden"  class="pricepppp"  value="<%=cart.get("p_price") %>" />
                        </div>
                        </div>
                        <div class="col-md-2 col-4">
                            <div class="quantity-container d-flex align-items-center mt-15">
                               
                                <input type="text"  name="cart_qty" class="quantity-amount" value="<%=cart.get("cart_qty") %>" />
                                ...
                                <div class="arrow-btn d-inline-flex flex-column">
                                   ...
                                   <button class="update arrow" type="button" title="update Quantity" >변경</button>
                            </div>
                        </div>
                ...
                <div class="button-area d-flex align-items-center justify-content-between flex-wrap">
                    <input type="button" class="view-btn color-2" value="DELETE" onClick="deleteDirect();"> &nbsp; 
               <input type="button" class="view-btn color-2" value="Checkout" onClick="checkoutInsertDirect();">
